    ...
    <View>
      ...
      <TouchableOpacity>
        <View style={styles.viewAvatarAndText}>
          <Image source={require('../../Resource/profile.png')} style={styles.imageProfile}></Image>
        ...
        <View style={styles.viewIn4Menu}>
          ...
          <View style={styles.viewIn4Menu1}>
            <View style={[styles.flex, { alignItems: 'center' }]}>
              <Image style={styles.image} source={require('../../Resource/calender.png')}></Image>
              <Text style={styles.textDate}>23-05-2023</Text>
            </View>
            <TouchableOpacity onPress={() => setisShow(!isShow)}>
              <Image style={styles.imageInvisible} source={require('../../Resource/invisible.png')}></Image>
            </TouchableOpacity>
          </View>
